...
uint16_t analyzerColumns2() {
  ...
  for (uint8_t bandIndex = 0; bandIndex < bandCount; bandIndex++) {
    ...
    CRGB colorLeft = ColorFromPalette(PartyColors_p, levelLeft / levelsPerHue); // CRGB colorLeft = ColorFromPalette(palette, bandIndex * (256 / bandCount));
    CRGB colorRight = ColorFromPalette(PartyColors_p, levelRight / levelsPerHue);
...
uint16_t analyzerColumns3() {
  ...
  for (uint8_t bandIndex = 0; bandIndex < bandCount; bandIndex++) {
    ...
    CRGB colorLeft = ColorFromPalette(OceanColors_p, levelLeft / levelsPerHue); // CRGB colorLeft = ColorFromPalette(palette, bandIndex * (256 / bandCount));
    CRGB colorRight = ColorFromPalette(OceanColors_p, levelRight / levelsPerHue);
...
//    CRGB colorLeft = ColorFromPalette(OceanColors_p, levelLeft / levelsPerHue);
//    CRGB colorRight = ColorFromPalette(OceanColors_p, levelRight / levelsPerHue);
    CRGB colorLeft = ColorFromPalette(palette, gHue);
    CRGB colorRight = ColorFromPalette(palette, gHue);
